...
public class PlantCenfomon implements Cenfomon {
    private int id;
    private String name;
    ...
    public PlantCenfomon() {}

    public PlantCenfomon(int id, String name, String description, int initialHp, int initialAttack, int initialDefense, int initialExp, String type, ArrayList<Attack> attacks, String debilidad) {
        this.id = id;
        this.name = name;
