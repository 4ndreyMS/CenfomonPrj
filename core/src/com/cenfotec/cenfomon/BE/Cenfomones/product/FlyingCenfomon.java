...
public class FlyingCenfomon implements Cenfomon {
    private int id;
    private String name;
    ...
    public FlyingCenfomon() {
    }

    public FlyingCenfomon(int id, String name, String description, int initialHp, int initialAttack, int initialDefense, int initialExp, String type, ArrayList<Attack> attacks, String debilidad) {
        this.id = id;
        this.name = name;
