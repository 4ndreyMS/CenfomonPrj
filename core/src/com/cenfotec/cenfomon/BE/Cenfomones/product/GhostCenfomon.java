...
public class GhostCenfomon implements Cenfomon {
    private int id;
    private String name;
    ...
    public GhostCenfomon() {

    }

    public GhostCenfomon(int id, String name, String description, int initialHp, int initialAttack, int initialDefense, int initialExp, String type, ArrayList<Attack> attacks, String debilidad) {
        this.id = id;
        this.name = name;
